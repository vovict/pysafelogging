...
class BaseRotatingHandler(pysafelogging.FileHandler):
    ...
    def __init__(self, filename, mode, encoding=None, delay=False):
        ...
        """
        pysafelogging.FileHandler.__init__(self, filename, mode, encoding,
                                           delay)
        self.mode = mode
...
class SafeTimedRotatingFileHandler(TimedRotatingFileHandler):
    ...
    def shouldRollover(self, record):
        ...
        if self.suffix_time != time.strftime(self.suffix,
                                             timeTuple) or not os.path.exists(
...
class NTEventLogHandler(pysafelogging.Handler):
    ...
    def __init__(self, appname, dllname=None, logtype="Application"):
        ...
        try:
            ...
            self.typemap = {
                pysafelogging.DEBUG: win32evtlog.EVENTLOG_INFORMATION_TYPE,
...
class MemoryHandler(BufferingHandler):
    ...
    def __init__(self, capacity, flushLevel=pysafelogging.ERROR, target=None,
                 flushOnClose=True):
        """
